...
* **Correct (%)**:<br>
  Percentage of solved plans generated by the planner that are correct. Correctness means that path trajectory avoids collisions and all way points satisfy given bounds.
